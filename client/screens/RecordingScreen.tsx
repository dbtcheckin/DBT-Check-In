...
export default function RecordingScreen() {
  ...
  const { connectRealtime, disconnect, getTranscript, getMessages, connectionError, isSupported, simulationState: simState, toggleMute, setMutedState, isMuted } = useSimulatedWebRTC();
    ...
    <View style={[styles.container, { backgroundColor: theme.backgroundRoot }]}>
      <View style={[styles.header, { paddingTop: insets.top + Spacing.md }]}>
        ...
        {isRecording || connectionState === "connecting" ? (
          ...
          <View style={styles.headerDonePlaceholder} />
        )}
      ...
      {isProcessing ? (
        ...
        >
          ...
          <View style={[styles.transcriptSection, { paddingBottom: insets.bottom + Spacing.sm }]}>
            {messages.length > 0 ? (
              <ScrollView
                ref={scrollViewRef}

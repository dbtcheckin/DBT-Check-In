...
export const Colors = {
  light: {
    text: "#f5f4f2",
    textSecondary: "rgba(245, 244, 242, 0.6)",
    textTertiary: "rgba(245, 244, 242, 0.4)",
    textGhost: "rgba(245, 244, 242, 0.15)",
    textDisabled: "#4b5563",
    buttonText: "#ffffff",
    ...
    accent: "#c4a67c",
    accentMuted: "rgba(196, 166, 124, 0.15)",
    accentGlow: "rgba(196, 166, 124, 0.25)",
